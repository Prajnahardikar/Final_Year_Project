...
def filt(file_name):
    ...
    path = r"C:\Users\shantha\Documents\FYP\inria-bci-challenge\Test_filter\\" + file_name[0:len(file_name)-4] + "_filt.csv"
    filt.to_csv(path, index = False)

extension = 'csv'
os.chdir(r"C:\Users\shantha\Documents\FYP\inria-bci-challenge\test")
